more_books = [
    ...
    {:title => 'The Adventures of Tom Sawyer', :genre => 'Action and Adventure', 
      ...
      :isbn_number => '9781948132824', :publish_date => '06/05/2018'},
    {:title => 'The President Is Missing', :genre => 'Mystery', 
      ...
      :isbn_number => '9781538713839', :publish_date => '11/06/2019'},
    {:title => 'It Ends with Us', :genre => 'Romance', 
      ...
      :isbn_number => '9781501110368', :publish_date => '02/08/2016'}
  ]
